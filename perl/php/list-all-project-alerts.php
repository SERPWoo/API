...
//
// Last updated - Aug 24th, 2017 @ 18:48 EST (@MercenaryCarter https://github.com/MercenaryCarter and https://twitter.com/MercenaryCarter)
//
//
// Run Command: php list-all-project-alerts.php
	...
	// Get your API Key here: https://www.serpwoo.com/v3/api/ (should be logged in)
		...
		$Project_ID = PROJECT_ID_HERE; #Integer, example = 12345
							    ...
							    foreach($jsons_data as $project_id => $value_level_2) {
									  ...
									  // (Sample output: https://api.serpwoo.com/#projects-keywords)
									    foreach($value_level_2 as $key_3 => $alert_array) {
											    ...
											    foreach($alert_array as $note_id => $keyword_data) {

				  								  //echo "3rd Level=[" . $$note_id . "][" . $$keyword_data . "]<br>";
									
														$social_time = $JSONData['projects'][$project_id]['alerts'][$note_id]['social_time'];
														$alert_text = $JSONData['projects'][$project_id]['alerts'][$note_id]['text'];
														$alert_link = $JSONData['projects'][$project_id]['alerts'][$note_id]['link'];

			  										  echo "<tr>";
													  echo "<td style='text-align: center;'><span style='color: #0099ff;'>" . $note_id . "</span></td>";
